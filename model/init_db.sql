...
INSERT INTO regions (region_name, region_description)  
    ...
    ('Montserrat', "Montserrat és la muntanya més representativa de Catalunya. Des dels seus pics anomenats agulles es pot admirar una meravellosa panoràmica des dels Pirineus al mar i els dies clars, fins i tot, s'arriba a veure l'illa de Mallorca. Té un biòtop molt especial que permet que una sèrie d'espècies de fauna i flora trobin el refugi i l'aliment que no tindrien en altres zones."),
